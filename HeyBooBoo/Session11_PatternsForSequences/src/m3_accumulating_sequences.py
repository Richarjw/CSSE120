...
def test_make_simple_list():
    ...
    print('--------------------------------------------------')
    test1 = make_simple_list(5, 13)
    print(test1)
    test2 = make_simple_list(2, 18)
    print(test2)
...
def test_make_simple_string():
    ...
    test1 = make_simple_string(5, 13)
    print(test1)
    test2 = make_simple_string(2, 10)
    print(test2)
...
def test_draw_shapes():
    ...
    various[0].set_fill = 'green'
    various[1].set_fill = 'yellow'
    various[2].set_fill = 'red'
    various[3].outline_thickness = 10
