...
def wiggle():
    ...
    """
    width = 1100  # I changed the values of width and Height.
    height = 800
    ...
    for k in range(100000):
        delta_x = random.randrange(-100, 100)  # between -12 and 12
        delta_y = random.randrange(-100, 100)  # between -5 and 12

        circle.move(delta_x, delta_y)
        time.sleep(2 / (k + 2))  # units are seconds so starts at 1 sec
