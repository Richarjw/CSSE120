...
def do_sums():
    ...
    print(sum_of_digits(a) * sum_of_digits(b) * sum_of_digits(c))
    print(sum_of_digits(sum_of_digits(a) * sum_of_digits(b) * sum_of_digits(c)))
...
def do_shared_factors():
    ...
    print(number_of_shared_factors(m, n))
    print(number_of_shared_factors(m * m, n * n))
    print(number_of_shared_factors(m + 1, n + 1))
#-----------------------------------------------------------------------
