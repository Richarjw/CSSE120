...
def test_return_it():
    ...
    print('Expected, returned:', 19084, answer2)
    print('Expected, returned:', 124309, answer3)
...
def digits_in_squares_and_cubes(n):
    ...
    print(n ** 2, sum_of_digits(n ** 2))
    print(n ** 3, sum_of_digits(n ** 3))
