...
def test_sum_more_cosines():
    ...
    print('--------------------------------------------------')
    print('expected: 0.13416')
    test = sum_more_cosines(0, 3)
    print(test)
    print('expected:-0.39533')
    test2 = sum_more_cosines(-4, 2)
    print(test2)
    print('expected: 1')
    test3 = sum_more_cosines(0, 0)
    print(test3)
...
def test_count_sines_from():
    ...
    print('--------------------------------------------------')
    test1 = count_sines_from(3, 9)
    test2 = count_sines_from(4, 6)
    test3 = count_sines_from(7, 7)
    print('expected: 5 3 0')
...
def test_count_sines_vs_cosines():
    ...
    print('--------------------------------------------------')
    test1 = count_sines_vs_cosines(5)
    test2 = count_sines_vs_cosines(3)
    test3 = count_sines_vs_cosines(0)
    print('expected: 6 4 0')
    print(test1, test2, test3)
