...
def test_factorial():
    ...
    print('--------------------------------------------------')
    print('expected: 120 24 6 2')
    print(factorial(5), factorial(4), factorial(3), factorial(2))
...
def test_count_cosines_from():
    ...
    print(count_cosines_from(3, 9, 0.29), count_cosines_from(3, 9, 0.27), count_cosines_from(4, 8, -0.5), count_cosines_from(3, 4, 1))
...
def average(n, r):
    ...
    average = 0
    for k in range(1, n + 1):
        average = average + random.randrange(0, r)
    average = average / n
    return average
...
def test_sum_unit_fractions_from():
    ...
    print('--------------------------------------------------')
    print('expected: 2.08 0.833 0.617 0.546')
    print(sum_unit_fractions_from(1, 4), sum_unit_fractions_from(2, 3), sum_unit_fractions_from(4, 6), sum_unit_fractions_from(6, 9))
