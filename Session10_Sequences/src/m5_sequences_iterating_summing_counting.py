...
def test_count_items_bigger_than():
    ...
    test1 = [45, 84, 32, 70]
    test2 = [50, 2, 300, 12]
    print('Expected, Actual : ', count_items_bigger_than(test1, 20), 4)
    print('Expected, Actual : ', count_items_bigger_than(test2, 10), 3)
...
def test_count_positive_sines():
    ...
    number2 = [3, 6, 8]
    print('Expected, Actual', count_positive_sines(number), 4)
    print('Expected, Actual', count_positive_sines(number2), 2)
...
def test_sum_first_n():
    ...
    print('Expected, Actual', sum_first_n(test1, 0), 0)
    print('Expected, Actual', sum_first_n(test1, 1), 48)
    print('Expected, Actual', sum_first_n(test1, 4), 93)
