...
def test_make_simple_list():
    ...
    print('--------------------------------------------------')
    test1 = make_simple_list(3, 10)
    print(test1)
    test2 = make_simple_list(2, 5)
    print(test2)
...
def test_make_less_simple_string():
    ...
    print('--------------------------------------------------')
    test1 = make_less_simple_string(5, 13)
    print(test1)
...
def rectangles_from_circles(circles):
    ...
    theCircles = circles
    rectangles = []
    for k in range(len(theCircles)):
        rectangle = rg.Rectangle(theCircles[k].center, 2 * theCircles[k].radius, 2 * theCircles[k].radius)
